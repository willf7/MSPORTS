    ...
    items.map((val) => {
        if(val.new == true){
            productAreaNew.innerHTML += `
                ...
                <img src="${val.img}" class="product_img" data-hover-src="${val.img2}" />
                    <p>${val.name}</p>
        ...
        productArea.innerHTML += `
            <div class="product_single ${productCount >= 4 ? 'hidden_product' : ''}">
                <img src="${val.img}" class="product_img" data-hover-src="${val.img2}" />
                <p>${val.name}</p>
                <div class= "product_vals">
                    <h3 class="reais">R$</h3>
            ...
            <div class="cart_item" id="${val.id}">
                ...
                <div class="cart_item_texts">
                    ...
                    <div class="cart_item_quantity">
                        <button class="quantity_btn decrease" data-id="${val.id}">-</button>
                        <p class="quantity_value">${val.quantidade}</p>
                        <button class="quantity_btn increase" data-id="${val.id}">+</button>
                    </div>
                </div>
            </div>
            <br>
...
function hiddenCart() {
    ...
    cartShow.addEventListener('animationend', () => {
...
function attachListeners() {
    ...
    displayShow.addEventListener("click", (event) => {
        if (event.target === displayShow) {  // Ver se o click foi no overlay
            hiddenCart();
        }
    });
}
...
function toggleSearch () {
    ...
    let productTemplates = matchedItems.map(item => {
        return `
        <div class="product_search_item">
        <img src="${item.img}" class="product_img" data-hover-src="${item.img2}" />
                <p>${item.name}</p>
                <div class= "product_vals">
                    <h3 class="reais">R$</h3>
